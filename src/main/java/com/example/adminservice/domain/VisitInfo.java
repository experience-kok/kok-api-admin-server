...
public class VisitInfo {
    ...
    @Builder
    public VisitInfo(String contactPhone, String homepage, String businessAddress, 
     ...
     * 방문 정보 업데이트
     */
    public VisitInfo update(String contactPhone, String homepage, String businessAddress,
                          String businessDetailAddress, Double lat, Double lng) {
